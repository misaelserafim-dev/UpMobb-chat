...
const SEED: EquipeMember[] = [
  {
    id: "eq-nicoly",
    name: "Nicoly",
    email: "nicoly@upmobb.frontend.teste.com",
  ...
  },
  {
    id: "eq-carlos",
    name: "Carlos",
    email: "carlos@upmobb.frontend.teste.com",
  ...
  },
  {
    id: "eq-ana",
    name: "Ana Paula",
    email: "ana@upmobb.frontend.teste.com",
    connectionId: "comercial-upmobb",
    profile: "user",
    status: "online",
  ...
  },
  {
    id: "eq-bruno",
    name: "Bruno Silva",
    email: "bruno.silva@upmobb.frontend.teste.com",
    connectionId: "qrcode-suporte",
    profile: "user",
    status: "online",
    departamentoIds: ["dept-suporte"],
  ...
  },
  {
    id: "eq-camila",
    name: "Camila Rocha",
    email: "camila.rocha@upmobb.frontend.teste.com",
    connectionId: "comercial-upmobb",
    profile: "user",
    status: "offline",
    departamentoIds: ["dept-comercial"],
  ...
  },
  {
    id: "eq-diego",
    name: "Diego Alves",
    email: "diego.alves@upmobb.frontend.teste.com",
    connectionId: "comercial-upmobb",
    profile: "admin",
    status: "online",
    departamentoIds: ["dept-financeiro", "dept-comercial"],
    permissions: {
      ...emptyEquipePermissions(),
      historico: true,
      "ver-tickets": true,
