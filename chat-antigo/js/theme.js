export const SYSTEM_COLORS = [
  {
    ...
    accentText: "#FFFFFF",
    bubbleIn: "#f7f8fa",
    swatchImage: "assets/ico_pwa.png",
  },
  {
    id: "default",
    label: "Padrão",
...
export function applyTheme(id) {
  ...
  root.setProperty(
    "--accent-hover-text",
    theme.accentHoverText || theme.accentText
  );
  ...
  root.removeProperty("--msg-text");
  root.removeProperty("--text");
  root.removeProperty("--text-muted");
  root.removeProperty("--text-soft");
  root.removeProperty("--theme-text");
